...
const ProductCard: React.FC<ProductCardProps> = ({data}) => {
  ...
  return (
    <div onClick={() => routing.push(`/product/${data.id}`)} className="col-span-1 cursor-pointer border-[1.2px] border-slate-200 bg-white rounded-lg p-2 transition hover:scale-105 text-center text-sm">
