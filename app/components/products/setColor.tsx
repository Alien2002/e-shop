  ...
  return (
    <div className="flex gap-4 items-center">
        ...
        <div className="flex gap-1">
            {
                images.map((images) => {
                    return <div key={images.color} className={`h-7 w-7 rounded-full border-teal-300 flex items-center justify-center ${cartProduct.selectedImage.color === images.color? 'border-[1.5px]' : 'border-none'}`}>
                        <div
